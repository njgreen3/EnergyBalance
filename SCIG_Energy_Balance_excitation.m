...
% Initially assume load is across a line voltage of -inf per-unit to start while loop
V_load = -inf;
% Initially assume phase voltage is inf to start while loop
Vph = inf;
...
while(any(any(abs(V_load - abs(Vph)) > err)))
